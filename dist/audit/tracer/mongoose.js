...
var MongooseTracker = /** @class */ (function () {
    function MongooseTracker(options) {
        this._options = { collectionName: 'audit', connectionString: '', appName: 'DEFAULT' };
    ...
    MongooseTracker.prototype.executeAggreagteQuery = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.model.aggregate(query).exec()
    ...
    MongooseTracker.prototype.executeResolveQuery = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.model.update({ _id: id }, { $set: { resolved: true } }).exec()
                        .then(function (result) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, result];
                        });
